import{e,Z as a,o as l,P as t,Q as r,c as u,J as s}from"./@vue_runtime-core@3.2.47-ac740756.js";import{r as i,j as o}from"./@vue_reactivity@3.2.47-31538bbf.js";import"./@vue_shared@3.2.47-177e1703.js";const n=e({__name:"edit",setup(e){const n=i(null),p=e=>{},c=()=>{n.value.resetFormFields()},m=()=>{n.value.clearValidate()},g=()=>{n.value.saveHandle()},b=o({goodsInformation:{title:"货品信息",name:"goodsInformation",ref:null,opts:{labelPosition:"top",formData:{id:`${Math.floor(10*Math.random()+1)}`,
// *唯一ID
account:null,
// *用户账号
password:null,
